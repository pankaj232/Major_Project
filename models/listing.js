...
const listingSchema = new mongoose.Schema({
  ...
  image: {
    ...
    url: {
      ...
      set: (v) =>
        v === "" ? "https://images.unsplash.com/photo-1748689612568-2c52a597bd38?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" : v,
    },
  },
  price: Number,
  location: String,
